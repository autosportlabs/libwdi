 ...
 */
#define DESC        "Autosport Labs Bootloader"
#define VID         0x16d0
#define PID         0x0673
#define INF_NAME    "usb_device.inf"
#define DEFAULT_DIR "usb_driver"
#define DEFAULT_USBLIB WDI_LIBUSB0
#define DEFAULT_VENDORNAME "Autosport Labs"
...
int __cdecl main(int argc, char** argv)
{
	...
	opd.driver_type = DEFAULT_USBLIB;
	opd.vendor_name = DEFAULT_VENDORNAME;
